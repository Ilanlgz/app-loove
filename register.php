        ...
        <form method="POST" action="">
            <div class="form-row">
                <div class="form-group">
                    <label class="form-label" for="first_name">Prénom <span class="required">*</span></label>
                    <input type="text" id="first_name" name="first_name" class="form-input" required placeholder="Votre prénom">
                </div>
                <div class="form-group">
                    <label class="form-label" for="last_name">Nom <span class="required">*</span></label>
                    <input type="text" id="last_name" name="last_name" class="form-input" required placeholder="Votre nom">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="password" id="password" name="password" class="form-input" required minlength="6" placeholder="••••••••">
                </div>
                <div class="form-group">
            ...
            <div class="form-row">
                <div class="form-group">
                    <label class="form-label" for="date_of_birth">Date de naissance <span class="required">*</span></label>
                    <input type="date" id="date_of_birth" name="date_of_birth" class="form-input" required>
                </div>
                <div class="form-group">
                    <label class="form-label" for="gender">Genre <span class="required">*</span></label>
            ...
            <div class="form-group">
                <label class="form-label" for="location">Ville <span class="required">*</span></label>
                <input type="text" id="location" name="location" class="form-input" required placeholder="Paris, Lyon, Marseille...">
            </div>

            <div class="form-row">
                <div class="form-group">
                    <label class="form-label" for="occupation">Profession</label>
                    <input type="text" id="occupation" name="occupation" class="form-input" placeholder="Votre métier">
                </div>
                <div class="form-group">
                    <label class="form-label" for="height">Taille (cm)</label>
                    <input type="number" id="height" name="height" class="form-input" min="140" max="220" placeholder="175">
                </div>
            </div>

            <div class="form-group">
                <label class="form-label" for="interests">Centres d'intérêt</label>
                <input type="text" id="interests" name="interests" class="form-input" placeholder="Voyage, Sport, Cuisine, Musique, Art...">
            </div>

            <div class="form-group">
                <label class="form-label" for="bio">Présentation</label>
                <textarea id="bio" name="bio" class="form-input form-textarea" placeholder="Parlez-nous de vous en quelques mots..."></textarea>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="tel" id="phone" name="phone" class="form-input" 
                           value="<?php echo isset($register_data['phone']) ? htmlspecialchars($register_data['phone']) : ''; ?>">
                </div>
                <div class="form-group">
                    <label for="relationship_status" class="form-label">Statut relationnel</label>
                    <select id="relationship_status" name="relationship_status" class="form-select">
                        <option value="single" <?php echo (isset($register_data['relationship_status']) && $register_data['relationship_status'] === 'single') ? 'selected' : ''; ?>>Célibataire</option>
                        <option value="divorced" <?php echo (isset($register_data['relationship_status']) && $register_data['relationship_status'] === 'divorced') ? 'selected' : ''; ?>>Divorcé(e)</option>
                        <option value="separated" <?php echo (isset($register_data['relationship_status']) && $register_data['relationship_status'] === 'separated') ? 'selected' : ''; ?>>Séparé(e)</option>
                        <option value="widowed" <?php echo (isset($register_data['relationship_status']) && $register_data['relationship_status'] === 'widowed') ? 'selected' : ''; ?>>Veuf/Veuve</option>
                    </select>
                </div>
            </div>
